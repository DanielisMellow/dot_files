...
wallpaper=$HOME/Pictures/wallpapers/Anime-Room.png
waybar_style="$HOME/.config/waybar/style/[Dark] Obsidian Edge.css"
...
if [ ! -f ~/.config/hypr/.initial_startup_done ]; then
    ...
    gsettings set org.gnome.desktop.interface icon-theme WhiteSur-dark > /dev/null 2>&1 &
